...
python3 "$repository_root/scripts/acceptance/test_check_storage_authority_convergence.py"
python3 "$repository_root/scripts/acceptance/check_storage_authority_convergence.py"
