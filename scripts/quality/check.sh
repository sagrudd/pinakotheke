...
python3 -m unittest "$repository_root/scripts/release/test_check_rc_compatibility.py"
python3 -m unittest "$repository_root/scripts/release/test_prepare_rc_output.py"
python3 -m unittest "$repository_root/packaging/test_rc_packaging.py"
